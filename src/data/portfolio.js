...
export const projectsData = {
  team: [
    {
      ...
      techStack: ['Angular', 'NgRx', 'Node.js', 'Express', 'MongoDB', 'GraphQL', 'Tailwind CSS'],
      features: [
  ...
  individual: [
    ...
    },
    {
      ...
      shortDesc: 'A Kanban-style task manager with drag-and-drop, real-time updates, and team collaboration features.',
      ...
      features: [
        ...
        'Secure API with Express backend',
      ],
    },
  ],
};
